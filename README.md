...
#### Note: 
When adding a game to the table, it may take some time to load due to the large video game database.

# Independent Study - JSON Web Tokens
https://docs.google.com/presentation/d/1QaXIeQTDa_OqT21NyVIs0AkcNoGYLWHbn70rVkL8nP8/edit#slide=id.gd2a24bf3a7_0_1

# MongoDB Compass Connect URL

mongodb+srv://Albert:Password123123@csci3230u.kpmwm.mongodb.net/test
...
| :------------------------- |:------------------:|
| Albert Galuego             | galuegonew         |
| Connor Robertson           | ConnorRobertson    |
| Jevon Rambarran            | JevonRambarran99   |
| Shayan Khosravi            | shayan-bravo		  |
